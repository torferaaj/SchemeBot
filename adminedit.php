...
<form class="d-flex justify-content-center" method="POST" action="update1.php"  enctype="multipart/form-data">
<!-- Scheme bot En -->
<div style="margin: 50px;width:50%">
  
<p>Language - En</p>

<label style="visibility: hidden;">id<span style="color: red;"><input type="text" class="form-control" name="id"  value="<?php echo $id;?>" ></span> </label>
...
<button style="margin: auto;" class="btn btn-primary"  value="submit" type="submit" name="edit" value="UPDATE">update</button>
<button  class="btn btn-danger"  value="reset" type="reset" >Reset</button>
</div>
...
<?php 
     ...
     header("Location: authendication.php");
     exit();
}
 ?>