...
<table  class="table table-dark table-hover">
  ...
  <?php
        ...
        $records = mysqli_query($conn,"select nameEng,bcEng,amountEng,ecEng,deptEng from records where bcEng like '%women%' or bcEng like '%girl%'  or bcEng like '%widow%'"); // fetch data from database
  ...
  <tr >
    ...
    <td><?php echo $data['nameEng']; ?></td>
     <td><?php echo $data['bcEng']; ?></td>
      <td><?php echo $data['amountEng']; ?></td>
       <td><?php echo $data['ecEng']; ?></td>
        <td><?php echo $data['deptEng']; ?></td>
