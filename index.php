...
<body>
    ...
    <section class="bg-transparent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" style="color: rgb(40, 40, 138);" href="./login.php"><b>Admin login</b></a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" style="color: rgb(40, 40, 138);" href="#"><b>State Govt schemes</b></a></li>
                                <li><a class="dropdown-item" style="color: rgb(40, 40, 138);" href="#"><b>Central Govt schemes</b></a></li>
                                <li><a class="dropdown-item" style="color: rgb(40, 40, 138);" href="#"><b>PDF export</b></a></li>
                                <li><a class="dropdown-item" style="color: rgb(40, 40, 138);" href="#"><b>Contacts directions</b></a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" style="color: rgb(40, 40, 138);" href="https://tirunelveli.nic.in/history/"><b>History</b></a></li>
                                <li><a class="dropdown-item" style="color: rgb(40, 40, 138);" href="https://tirunelveli.nic.in/list-of-collectors/"><b>List of collectors</b></a></li>
                                <li><a class="dropdown-item" style="color: rgb(40, 40, 138);" href="https://tirunelveli.nic.in/about-district/whos-who/"><b>Who's who</b></a></li>
                                <li><a class="dropdown-item" style="color: rgb(40, 40, 138);" href="https://tirunelveli.nic.in/maps/"><b>Maps</b></a></li>
                                <li><a class="dropdown-item" style="color: rgb(40, 40, 138);" href="https://tirunelveli.nic.in/waterbody/"><b>Water body</b></a></li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown" style="font-size: 11px;">
                                    <li><a class="dropdown-item" style="color: rgb(40, 40, 138);" href="#"><b>Phone :</b> +91-0462-2501033<br>+91-0462-2501034<br>+91-0462-2501035</a></li>
                                    <li><a class="dropdown-item" style="color: rgb(40, 40, 138);" href="#"><b>E mail :</b> collrtnv@nic.in</a></li>
                                </ul>
                            </li>
                        </li>
                    </ul>
        ...
        <div class="alert alert-primary d-flex align-items-center" role="alert" style="position: absolute; width: 100%; height: 20px; ">
            ...
            <div>
                Covid-19 updates of Tirunelveli District ( covid care tirunelveli )    -
            </div>
            <a href="https://covidcaretirunelveli.in/english/">
                <i>Link for details</i>
            </a>
    ...
    <section class="bg-transparent" style="height: 100px;">
        ...
        <label for="exampleDataList" class="form-label"  style="color: red; top: 185px; position:absolute; right:7%;">
            <b>Search the Schemes with their Scheme name:</b> 
        </label>
        <form class="row g-3" method="POST" style="position:absolute; top:35%; right:3%;">
            ...
            <div class="col-auto">
                <button type="submit" class="btn btn-primary mb-3" name="sh" value="sh">Search</button>
                                    ...
                                    <div class="card " style="background: #fff; box-shadow: 13px 13px 28px 2px rgba(0, 0, 0, 0.035); padding: 7px 15px;">
                                        <div id="chat" class="conv-form-wrapper" >
                                            <form action="" method="GET" class="hidden">
                                                <select data-conv-question="Hello! I'm a bot . May I help you?" name="first-question">
                                                    <option value="yes">Yes</option>
                                                    <option value="no">No</option>
                                                </select>
                                                <div data-conv-fork="first-question">
                                                    <div data-conv-case="yes">
                                                        <input type="text" data-conv-question="That's pleasant to hear!" data-no-answer="true">
                                                        <audio src=""></audio>
                                                    </div>
                                    
                                                    <div data-conv-case="no">
                                                            <input type="text" name="name" data-conv-question="Okay fine. Have a nice day!" data-no-answer="true">
                                                            <select data-conv-question="Click 'Yes'<br> If you have any queries." name="sub" id="">
                                                                <option value="yes">Yes</option>
                                                            </select>
                                                ...
                                                <select data-conv-question="How can I help you?" name="second-question">
                                                ...
                                                <div data-conv-fork="second-question">
                                                    <div data-conv-case="view-categories">
                                                        <select data-conv-question="This are all the categories :" onchange="this.options[this.selectedIndex].value&&(window.location = this.options[this.selectedIndex].value);">
                                                            <option value="http://localhost/SchemeBot/women.php">Women</option>
                                                        </select>
                                                    </div>
                                                </div>
    ...
    <section class="bd-transparent print" style=" height: 500px;">
        ...
        <div class="card text-center " style="width: 400px; background-color: rgba(252, 252, 252, 0.76); top: 43px; left: 66%; height: 400px;">
            <div class="card-header" style="color: tomato; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: rgba(171, 200, 219, 0.562);" >
                <b>Your searching contents will appear here !</b> 
            </div>
            <div class="print-container card-body" id="to-print" style="overflow: visible; overflow-y: scroll; background-color: rgba(209, 215, 219, 0.562);">
                <?php
                    ...
                    {
                ?>
                <h5 class="card-title">Scheme details</h5>
                <p class="card-text text-start"><b>Scheme name :</b> <!--Awards to Bright students.--><?php echo $data['nameEng']; ?></p>
                <p class="card-text text-start"><b>Concerned Department :</b> <!--Adi Dravidar and Tribal Welfare Department--><?php echo $data['deptEng']; ?></p>
                <p class="card-text text-start"><b>Beneficiaries :</b><!--Students--><?php echo $data['bcEng']; ?></p>
                <p class="card-text text-start"><b>Amount :</b> <?php echo $data['bcEng']; ?></p>
                <p class="card-text text-start"><b>Description :</b> <!--Awards to Bright Students - First two boys and two girls in each district from each community viz., Adi Dravidar/ Tribal / Adi Dravidar Converted to Christianity who have passed 10th std., Public Examinations and continue their studies are given a sum of Rs.800/- for the first year and Rs.960/- for the next 5 years. Should have secured first and second place in the 10th Std, in the district. Continue their studies. No income limits .--><?php echo $data['ecEng']; ?></p>
                <p class="card-text text-start"><b>Contact address :</b> <br>Director of Adi Dravidar Welfare ,<br> Chennai-5. <br>Through the Educational Institutions.</p>
                ...
                <p class="card-text text-start"><b>Commissioner (ADW) :</b> Tmt S. Madumathi IAS., Direct - 28589855</p>
                <p class="card-text text-start"><b>FA and CAO :</b> Thiru K. Sriramulu Direct - 28419613</p>
                <p class="card-text text-start"><b>Concerned District :</b> All Districts</p>
            ...
            <div class="card-footer text-muted" style="height: 79px; background-color: rgba(171, 200, 219, 0.562);">
                <p style="position: absolute; top: 91%; right: 30%; color: tomato;"><i> Details of the required scheme:</i></p>
    ...
    <section style="margin-top: 5em;">
        <div class="containers">
            <div class="cards">
                ...
                <h3 style=" color: whitesmoke; font-size: 24px; margin: 20px 0 0 20px;"><b>Women</b></h3></a>
            ...
            <div class="cards">
                ...
                <h3 style="  color: whitesmoke; font-size: 24px; margin: 20px 0 0 20px;"><b>Agriculture</b></h3></a>
            ...
            <div class="cards">
                ...
                <h3 style="  color: whitesmoke; font-size: 24px; margin: 20px 0 0 20px;"><b>Education</b></h3></a>
            ...
            <div class="cards">
                ...
                <h3 style="  color: whitesmoke; font-size: 24px; margin: 20px 0 0 20px;"><b>Health</b></h3></a>
            ...
            <div class="cards">
                ...
                <h3 style=" color: whitesmoke; font-size: 24px; margin: 20px 0 0 20px;"><b>Child care</b></h3></a>
            ...
            <div class="cards">
                ...
                <h3 style="  color: whitesmoke; font-size: 24px; margin: 20px 0 0 20px;"><b>Insurance</b></h3></a>
            ...
            <div class="cards">
                ...
                <h3 style="  color: whitesmoke; font-size: 24px; margin: 20px 0 0 20px;"><b>Old age</b></h3></a>
            ...
            <div class="cards">
                ...
                <h3 style="  color: whitesmoke; font-size: 18px; margin: 20px 0 0 20px;"><b>Physically<br>Challenged</b></h3></a>
            ...
            <div class="cards">
                ...
                <h3 style="  color: whitesmoke; font-size: 24px; margin: 20px 0 0 20px;"><b>Homeless</b></h3></a>
            ...
            <div class="cards">
                ...
                <h3 style="  color: whitesmoke; font-size: 18px; margin: 20px 0 0 20px;"><b>SC/ST/OBC/<br>Minorities</b></h3></a>
    ...
    <section class="bg-transparent" style="position: relative; width: 100%; bottom: -400%; height: 500px; background: rgb(255, 255, 255);">
        <div class="card-p shadow-lg" style="background-color: rgba(166, 198, 224, 0.562); position: absolute; height: 400px; width: 250px; bottom: 8%; right: 75%; transition: 0.5s ease; cursor: pointer;">
            ...
            <div class="card-body">
                <h5 class="card-title">Manjolai</h5>
                <p class="card-text" style="font-size: 14px;">Manjolai is a beautiful hill station located in the Kalakad Mundanthurai Tiger Reserve.</p>
            </div>
        ...
        <div class="card-p shadow-lg" style="background-color: rgba(166, 198, 224, 0.562);position: absolute; height: 400px; width: 250px; bottom: 8%; right: 52%; transition: 0.5s ease; cursor: pointer;">
            ...
            <div class="card-body">
                <h5 class="card-title">Tambaraparani river</h5>
                <p class="card-text" style="font-size: 14px;">The river Tambaraparani originates on the eastern slopes of Western Ghats in Tirunelveli district of Tamil Nadu.</p>
            </div>
            <p class="card-footer bg-transparent"><small class="text-muted" style="font-size: smaller;">Last updated 3 mins ago</small></p>
        </div>
        ...
        <div class="card-p shadow-lg" style="background-color: rgba(166, 198, 224, 0.562);position: absolute; height: 400px; width: 250px; bottom: 8%; right: 29%; transition: 0.5s ease; cursor: pointer;">
            ...
            <div class="card-body">
                <h5 class="card-title">kappal madha church</h5>
                <p class="card-text" style="font-size: 14px;">Kappal Matha Church is One of The Best Sightseeing Places to Visit in Tirunelveli, Tamil Nadu.</p>
            </div>
            <p class="card-footer bg-transparent"><small class="text-muted" style="font-size: smaller;">Last updated 3 mins ago</small></p>
        </div>
        ...
        <div class="card-p shadow-lg" style="background-color: rgba(166, 198, 224, 0.562);position: absolute; height: 400px; width: 250px; bottom: 8%; right: 6%; transition: 0.5s ease; cursor: pointer;">
            ...
            <div class="card-body">
                <h5 class="card-title">Manimuthar dam</h5>
                <p class="card-text" style="font-size: 14px;">The Manimuthar Dam is situated at the foothills of the scenic Podhigai Hills. It is built on the Thamirabarani River.</p>
            </div>
            <p class="card-footer bg-transparent"><small class="text-muted" style="font-size: smaller;">Last updated 3 mins ago</small></p>
        </div>
    </section>
